...
bool hasHttps = urls.Any(u => u.StartsWith("https:"));

Console.WriteLine($"应用已启动在:");
Console.WriteLine($"  HTTP:  http://localhost:5004");
if (hasHttps)
{
    Console.WriteLine($"  HTTPS: https://localhost:5443");
}
Console.WriteLine($"  Swagger: {(hasHttps ? "https://localhost:5443" : "http://localhost:5004")}/swagger");
