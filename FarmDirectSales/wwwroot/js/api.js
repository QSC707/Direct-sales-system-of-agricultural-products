...
window.API_BASE_URL = window.AppConfig.getApiUrl('');
...
const api = {
    ...
    auth: {
        ...
        register: async (userData) => {
            ...
            console.log('发送到服务器的数据:', requestData); // 添加调试日志
    ...
    user: {
        ...
        updateUserInfo: async (userData) => {
            try {
                ...
                const response = await fetch(`${window.API_BASE_URL}/auth/user/${user.userId}`, {
                    method: 'PUT',
                    headers: window.getHeaders(),
        ...
        changePassword: async (passwordData) => {
            try {
                ...
                const response = await fetch(`${window.API_BASE_URL}/auth/user/${user.userId}/password`, {
                    method: 'PUT',
                    headers: window.getHeaders(),
                    body: JSON.stringify({
