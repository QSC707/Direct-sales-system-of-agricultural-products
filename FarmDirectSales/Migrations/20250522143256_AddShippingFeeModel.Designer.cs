...
namespace FarmDirectSales.Migrations
{
    ...
    [Migration("20250522143256_AddShippingFeeModel")]
    partial class AddShippingFeeModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FarmDirectSales.Models.Order", b =>
                {
                    ...
                    b.HasOne("FarmDirectSales.Models.ShippingFee", "ShippingFeeRule")
                        .WithMany()
